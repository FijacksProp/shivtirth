...
class Special_Packages(models.Model):
    ...
    first_img = models.ImageField(default='image/new/31150.jpg', upload_to='image/up_images', null=True, blank=True)
    second_img = models.ImageField(default='image/new/31150.jpg', upload_to='image/up_images', null=True, blank=True)
...
class Post(models.Model):
    ...
    main_img = models.ImageField(default='image/new/31150.jpg', upload_to='image/up_images', null=True, blank=True)
...
class Packages(models.Model):
    ...
    img = models.ImageField(default='image/new/31150.jpg', upload_to='image/up_images', null=True, blank=True)
...
class Gallery(models.Model):
    ...
    dis_img = models.ImageField(default='image/new/31150.jpg', upload_to='image/up_images', null=True, blank=True)
    img = models.ImageField(default='image/new/31150.jpg', upload_to='image/up_images', null=True, blank=True)
    date_created = models.DateTimeField(default=now)
